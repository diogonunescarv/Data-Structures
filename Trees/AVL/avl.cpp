...
// Faz as rotações e ajustes necessários inclusive do nó pai. Atualiza a altura. Retorna o ponteiro para o nó que ficar na posição dele após os ajustes.
...
// Insere um nó numa subárvore. Retorna o ponteiro para o nó que ficou no lugar do que recebeu a mensagem.
...
// Remove o nó. Retorna o ponteiro para o nó que ficou no lugar dele. Confira com RemoverRecursivo(TChave).
...
// Busca recursivamente um nó com dada chave e o remove. Retorna o ponteiro para o nó que ficou no lugar do nó que recebeu a mensagem. Confira com Remover().
...
// Atualiza todas as ligações, para que ptNoh, fique no lugar deste nó. Usado na remoção com dois filhos.
...
// Muda as ligações do pai e do filho para desligar o nó atual. Usado para remoção na situação em que não existem os dois filhos.
...
// Busca recursivamente uma dada chave e retorna o valor associado a ela. Levanta exceção se não encontrar a chave.
...
// Escreve o conteúdo de um nó no formato [altura:chave/valor]. Escreve "[]" se o ponteiro recebido for NULL.
...
// Escreve o conteúdo da árvore nível a nível, na saída de dados informada. Usado para conferir se a estrutra da árvore está correta.
